 ...
 */
  extern size_t POMP2_Get_num_regions(void);
 ...
 */
  extern const char *POMP2_Get_opari2_version(void);

/*@}*/
/** Function that returns a new task handle.
 * @return new task handle */

  extern POMP2_Task_handle POMP2_Get_new_task_handle(void);
 ...
 */
  extern void
   POMP2_Task_create_begin(POMP2_Region_handle * pomp2_handle,
			   ...
			   POMP2_Task_handle * pomp2_old_task,
			   int pomp2_if, const char ctc_string[]);
